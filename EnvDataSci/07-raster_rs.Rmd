...
```{r echo=FALSE}
northBoundv <- vect("/Users/hkropp/Documents/GitHub/Intro_EnvDataSci/EnvDataSci/data/chapter07/northBound.shp")

midBoundv <- vect("/Users/hkropp/Documents/GitHub/Intro_EnvDataSci/EnvDataSci/data/chapter07/midBound.shp")
```
...
```{r echo=TRUE}
plotRGB(postR, r=3,g=2,b=1, stretch="lin")
plot(northBoundv, border="tomato3", fill=NA, lwd=3, add=TRUE)
```
...
```{r echo=TRUE}
northBound <- project(northBoundv, "epsg:4326")
midBound <- project(midBoundv, "epsg:4326")
```
